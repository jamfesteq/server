...
UPDATE rule_values SET rule_value='16384' WHERE rule_name='World:CharacterSelectExpansionSettings';
UPDATE rule_values SET rule_value='16384' WHERE rule_name='World:ExpansionSettings';
