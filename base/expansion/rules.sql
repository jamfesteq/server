...
UPDATE rule_values SET rule_value='This is an early alpha of jamfest. Currently on Omens of War, #opt in to cool commands to speed things up. Check out https://jamfesteq.com for patcher and intro. Expect characters to be deleted for beta. Guildmasters are handy, hail them.' WHERE rule_name='World:MOTD';
