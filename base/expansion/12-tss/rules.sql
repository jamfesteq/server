...
UPDATE rule_values SET rule_value='4095' WHERE rule_name='World:CharacterSelectExpansionSettings';
UPDATE rule_values SET rule_value='4095' WHERE rule_name='World:ExpansionSettings';
